...
export const viLanding: LandingStrings = {
  header: {
    ...
    nav: [
      { label: 'Giới thiệu', href: '#mv-intro-title' },
      { label: 'Hậu quả', href: '#mv-consequences-title' },
      { label: 'Cam kết', href: '#mv-voice-title' },
      { label: 'Quy trình', href: '#mv-steps-title' },
      { label: 'Vi phạm', href: '#mv-violations-title' },
      { label: 'Câu hỏi', href: '#mv-faq-title' },
      { label: 'Kháng nghị', href: '#mv-cta-title' },
    ],
