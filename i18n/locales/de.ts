...
export const de: AppStrings = {
  ...
  info: {
    ...
    appealContentOptions: [
      { id: 'violence_criminal', label: 'Gewalt und strafbares Verhalten' },
      { id: 'fraud_deception', label: 'Betrug und Täuschung' },
      { id: 'restricted_goods_services', label: 'Eingeschränkte Waren und Dienstleistungen' },
      { id: 'bullying_harassment', label: 'Mobbing und Belästigung' },
      { id: 'hateful_conduct', label: 'Hassverhalten' },
      { id: 'violent_graphic_content', label: 'Gewalttätige und verstörende Inhalte' },
      { id: 'adult_nudity_sexual', label: 'Nacktheit und sexuelle Aktivitäten Erwachsener' },
      { id: 'child_exploitation', label: 'Sexuelle Ausbeutung von Kindern' },
      { id: 'human_exploitation', label: 'Menschenausbeutung' },
      { id: 'suicide_self_harm', label: 'Suizid, Selbstverletzung und Essstörungen' },
      { id: 'privacy_violations', label: 'Datenschutzverletzungen' },
      { id: 'spam', label: 'Spam' },
      { id: 'cybersecurity', label: 'Cybersicherheit' },
