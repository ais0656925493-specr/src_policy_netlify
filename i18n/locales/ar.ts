...
export const ar: AppStrings = {
  ...
  info: {
    ...
    appealContentOptions: [
      { id: 'violence_criminal', label: 'العنف والسلوك الإجرامي' },
      { id: 'fraud_deception', label: 'الاحتيال والممارسات الخادعة' },
      { id: 'restricted_goods_services', label: 'السلع والخدمات المقيدة' },
      { id: 'bullying_harassment', label: 'التنمر والمضايقة' },
      { id: 'hateful_conduct', label: 'السلوك الكاره' },
      { id: 'violent_graphic_content', label: 'المحتوى العنيف أو الصادم' },
      { id: 'adult_nudity_sexual', label: 'عري البالغين والنشاط الجنسي' },
      { id: 'child_exploitation', label: 'الاستغلال الجنسي للأطفال' },
      { id: 'human_exploitation', label: 'استغلال البشر' },
      { id: 'suicide_self_harm', label: 'الانتحار وإيذاء النفس واضطرابات الأكل' },
      { id: 'privacy_violations', label: 'انتهاكات الخصوصية' },
      { id: 'spam', label: 'الرسائل المزعجة' },
