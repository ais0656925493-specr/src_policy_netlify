...
export const cs: AppStrings = {
  ...
  info: {
    ...
    appealContentOptions: [
      { id: 'violence_criminal', label: 'Násilí a trestná činnost' },
      { id: 'fraud_deception', label: 'Podvody a klamavé praktiky' },
      { id: 'restricted_goods_services', label: 'Omezené zboží a služby' },
      { id: 'bullying_harassment', label: 'Šikana a obtěžování' },
      { id: 'hateful_conduct', label: 'Nenávistné jednání' },
      { id: 'violent_graphic_content', label: 'Násilný nebo grafický obsah' },
      { id: 'adult_nudity_sexual', label: 'Nahota a sexuální aktivita dospělých' },
      { id: 'child_exploitation', label: 'Sexuální vykořisťování dětí' },
      { id: 'human_exploitation', label: 'Vykořisťování lidí' },
      { id: 'suicide_self_harm', label: 'Sebevražda, sebepoškozování a poruchy příjmu potravy' },
      { id: 'privacy_violations', label: 'Porušení soukromí' },
      { id: 'spam', label: 'Spam' },
      { id: 'cybersecurity', label: 'Kybernetická bezpečnost' },
