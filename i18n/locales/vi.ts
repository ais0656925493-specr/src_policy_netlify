...
export const vi: AppStrings = {
  ...
  info: {
    ...
    appealContentOptions: [
      { id: 'violence_criminal', label: 'Bạo lực và hành vi phạm pháp' },
      { id: 'fraud_deception', label: 'Lừa đảo và gian dối' },
      { id: 'restricted_goods_services', label: 'Hàng hóa và dịch vụ bị hạn chế' },
      { id: 'bullying_harassment', label: 'Bắt nạt và quấy rối' },
      { id: 'hateful_conduct', label: 'Ngôn từ thù ghét' },
      { id: 'violent_graphic_content', label: 'Nội dung bạo lực hoặc phản cảm' },
      { id: 'adult_nudity_sexual', label: 'Nội dung khỏa thân và hoạt động tình dục' },
      { id: 'child_exploitation', label: 'Bóc lột trẻ em' },
      { id: 'human_exploitation', label: 'Bóc lột người lớn và buôn người' },
      { id: 'suicide_self_harm', label: 'Tự tử, tự gây thương tích và rối loạn ăn uống' },
      { id: 'privacy_violations', label: 'Xâm phạm quyền riêng tư' },
      { id: 'spam', label: 'Spam' },
