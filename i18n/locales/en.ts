...
export const en: AppStrings = {
  ...
  info: {
    ...
    appealContentOptions: [
      { id: 'violence_criminal', label: 'Violence and criminal behavior' },
      { id: 'fraud_deception', label: 'Fraud and deceptive practices' },
      { id: 'restricted_goods_services', label: 'Restricted goods and services' },
      { id: 'bullying_harassment', label: 'Bullying and harassment' },
      { id: 'hateful_conduct', label: 'Hateful conduct' },
      { id: 'violent_graphic_content', label: 'Violent and graphic content' },
      { id: 'adult_nudity_sexual', label: 'Adult nudity and sexual activity' },
      { id: 'child_exploitation', label: 'Child sexual exploitation, abuse and nudity' },
      { id: 'human_exploitation', label: 'Human exploitation' },
      { id: 'suicide_self_harm', label: 'Suicide, self-injury and eating disorders' },
      { id: 'privacy_violations', label: 'Privacy violations' },
      { id: 'spam', label: 'Spam' },
