...
export const fr: AppStrings = {
  ...
  info: {
    ...
    appealContentTitle: 'Contenu de l\'appel',
    appealContentHint: 'Sélectionnez les domaines de politique que vous estimez que votre Page ne viole pas.',
    appealContentOptions: [
      { id: 'violence_criminal', label: 'Violence et comportement criminel' },
      { id: 'fraud_deception', label: 'Fraude et pratiques trompeuses' },
      { id: 'restricted_goods_services', label: 'Biens et services restreints' },
      { id: 'bullying_harassment', label: 'Intimidation et harcèlement' },
      { id: 'hateful_conduct', label: 'Conduite haineuse' },
      { id: 'violent_graphic_content', label: 'Contenu violent et choquant' },
      { id: 'adult_nudity_sexual', label: 'Nudité et activité sexuelle des adultes' },
      { id: 'child_exploitation', label: 'Exploitation sexuelle des enfants' },
      { id: 'human_exploitation', label: 'Exploitation humaine' },
      { id: 'suicide_self_harm', label: 'Suicide, automutilation et troubles alimentaires' },
      { id: 'privacy_violations', label: 'Atteintes à la vie privée' },
      { id: 'spam', label: 'Spam' },
      { id: 'cybersecurity', label: 'Cybersécurité' },
      { id: 'inauthentic_behavior', label: 'Comportement inauthentique' },
      { id: 'misinformation', label: 'Désinformation' },
      { id: 'intellectual_property', label: 'Propriété intellectuelle' },
      { id: 'ai_generated_content', label: 'Contenu généré par l\'IA' },
      { id: 'other', label: 'Autre (décrivez ci-dessous)' },
    ],
    errAppealContent: 'Veuillez sélectionner au moins un domaine de politique.',
    errAppealContentOther: 'Veuillez décrire votre appel en détail.',
    agree: 'J’accepte les',
