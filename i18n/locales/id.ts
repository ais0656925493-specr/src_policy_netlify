...
export const id: AppStrings = {
  ...
  info: {
    ...
    appealContentOptions: [
      { id: 'violence_criminal', label: 'Kekerasan dan perilaku kriminal' },
      { id: 'fraud_deception', label: 'Penipuan dan praktik menyesatkan' },
      { id: 'restricted_goods_services', label: 'Barang dan layanan yang dibatasi' },
      { id: 'bullying_harassment', label: 'Perundungan dan pelecehan' },
      { id: 'hateful_conduct', label: 'Perilaku kebencian' },
      { id: 'violent_graphic_content', label: 'Konten kekerasan atau grafis' },
      { id: 'adult_nudity_sexual', label: 'Ketelanjangan dan aktivitas seksual dewasa' },
      { id: 'child_exploitation', label: 'Eksploitasi seksual anak' },
      { id: 'human_exploitation', label: 'Eksploitasi manusia' },
      { id: 'suicide_self_harm', label: 'Bunuh diri, menyakiti diri, dan gangguan makan' },
      { id: 'privacy_violations', label: 'Pelanggaran privasi' },
      { id: 'spam', label: 'Spam' },
      { id: 'cybersecurity', label: 'Keamanan siber' },
