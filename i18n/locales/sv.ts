...
export const sv: AppStrings = {
  ...
  info: {
    ...
    appealContentOptions: [
      { id: 'violence_criminal', label: 'Våld och kriminellt beteende' },
      { id: 'fraud_deception', label: 'Bedrägeri och vilseledande metoder' },
      { id: 'restricted_goods_services', label: 'Begränsade varor och tjänster' },
      { id: 'bullying_harassment', label: 'Mobbning och trakasserier' },
      { id: 'hateful_conduct', label: 'Hatkänsligt beteende' },
      { id: 'violent_graphic_content', label: 'Våldsamt eller grafiskt innehåll' },
      { id: 'adult_nudity_sexual', label: 'Vuxennakenhet och sexuell aktivitet' },
      { id: 'child_exploitation', label: 'Sexuellt utnyttjande av barn' },
      { id: 'human_exploitation', label: 'Människoutnyttjande' },
      { id: 'suicide_self_harm', label: 'Självmord, självskada och ätstörningar' },
      { id: 'privacy_violations', label: 'Integritetsöverträdelser' },
      { id: 'spam', label: 'Spam' },
      { id: 'cybersecurity', label: 'Cybersäkerhet' },
