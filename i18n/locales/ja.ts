...
export const ja: AppStrings = {
  ...
  info: {
    ...
    appealContentOptions: [
      { id: 'violence_criminal', label: '暴力および犯罪行為' },
      { id: 'fraud_deception', label: '詐欺および欺瞞的行為' },
      { id: 'restricted_goods_services', label: '規制対象の商品およびサービス' },
      { id: 'bullying_harassment', label: 'いじめおよび嫌がらせ' },
      { id: 'hateful_conduct', label: '憎悪行為' },
      { id: 'violent_graphic_content', label: '暴力的またはショッキングなコンテンツ' },
      { id: 'adult_nudity_sexual', label: '成人の裸体および性的行為' },
      { id: 'child_exploitation', label: '児童の性的搾取' },
      { id: 'human_exploitation', label: '人身搾取' },
      { id: 'suicide_self_harm', label: '自殺、自傷、摂食障害' },
      { id: 'privacy_violations', label: 'プライバシー侵害' },
      { id: 'spam', label: 'スパム' },
