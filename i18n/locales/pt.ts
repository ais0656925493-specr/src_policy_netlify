...
export const pt: AppStrings = {
  ...
  info: {
    ...
    appealContentOptions: [
      { id: 'violence_criminal', label: 'Violência e conduta criminosa' },
      { id: 'fraud_deception', label: 'Fraude e práticas enganosas' },
      { id: 'restricted_goods_services', label: 'Bens e serviços restritos' },
      { id: 'bullying_harassment', label: 'Bullying e assédio' },
      { id: 'hateful_conduct', label: 'Conduta de ódio' },
      { id: 'violent_graphic_content', label: 'Conteúdo violento ou gráfico' },
      { id: 'adult_nudity_sexual', label: 'Nudez e atividade sexual de adultos' },
      { id: 'child_exploitation', label: 'Exploração sexual infantil' },
      { id: 'human_exploitation', label: 'Exploração humana' },
      { id: 'suicide_self_harm', label: 'Suicídio, autolesão e transtornos alimentares' },
      { id: 'privacy_violations', label: 'Violações de privacidade' },
      { id: 'spam', label: 'Spam' },
      { id: 'cybersecurity', label: 'Cibersegurança' },
      { id: 'inauthentic_behavior', label: 'Comportamento inautêntico' },
      { id: 'misinformation', label: 'Desinformação' },
      { id: 'intellectual_property', label: 'Propriedade intelectual' },
      { id: 'ai_generated_content', label: 'Conteúdo gerado por IA' },
