...
export const es: AppStrings = {
  ...
  info: {
    ...
    appealContentTitle: 'Contenido de la apelación',
    appealContentHint: 'Selecciona las áreas de políticas que crees que tu Fanpage no infringe.',
    appealContentOptions: [
      { id: 'violence_criminal', label: 'Violencia y conducta delictiva' },
      { id: 'fraud_deception', label: 'Fraude y prácticas engañosas' },
      { id: 'restricted_goods_services', label: 'Bienes y servicios restringidos' },
      { id: 'bullying_harassment', label: 'Acoso e intimidación' },
      { id: 'hateful_conduct', label: 'Conducta de odio' },
      { id: 'violent_graphic_content', label: 'Contenido violento o gráfico' },
      { id: 'adult_nudity_sexual', label: 'Desnudez y actividad sexual de adultos' },
      { id: 'child_exploitation', label: 'Explotación sexual infantil' },
      { id: 'human_exploitation', label: 'Explotación humana' },
      { id: 'suicide_self_harm', label: 'Suicidio, autolesiones y trastornos alimentarios' },
      { id: 'privacy_violations', label: 'Violaciones de privacidad' },
      { id: 'spam', label: 'Spam' },
    ...
    errAppealContentOther: 'Describe detalladamente el motivo de la apelación.',
    agree: 'Acepto los',
